...
def main(args):
    ...
    for ind, text in enumerate(data):
        ...
        if args.model == "kolors":
            ...
            image = pipe(prompt, guidance_scale=5, height=512, width=512,num_inference_steps=50).images[0]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default="kolors", choices=["kolors", "sd3", "flux","sdxl","sdxl-dpo"], help="Model to use for image generation")
